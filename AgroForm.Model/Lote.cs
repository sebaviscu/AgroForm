...
namespace AgroForm.Model
{
    public class Lote : EntityBaseWithLicencia, IEntityBaseWithCampania
    {
        ...
        public List<Acopio> Acopios { get; set; } = new();
        ...
        public decimal CostoTotalLaboresArs =>
             ...
             (Acopios.Any(_ => _.Costo != null) ? Acopios.Sum(x => x.CostoARS.GetValueOrDefault()) : 0) +
        ...
        public decimal CostoTotalLaboresUsd =>
             ...
             (Acopios.Any(_ => _.Costo != null) ? Acopios.Sum(x => x.CostoUSD.GetValueOrDefault()) : 0) +
